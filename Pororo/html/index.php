  ...
  <body role="document">
    ...
    <div class="container" role="main">
      ...
      <div class="jumbotron">
        ...
        <p>아래에는 3초 분량의 비디오 클립 20개가 포함되어 있는데, 본 내용과 보지 않은 내용이 무작위로 나열되어 있습니다. 각 비디오 클립에는 1점부터 5점까지 척도로 여부를 체크할 수 있는데, 보지 않았다라고 확신한다면 0점, 본 내용이다라고 확신한다면 5점을 체크하시면 됩니다.</p>
